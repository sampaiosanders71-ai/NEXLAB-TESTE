...
const BUILD_IDENTITY=self.__NEXLAB_BUILD_IDENTITY__||Object.freeze({version:'0.26.43',release:'Beta',revision:'beta-0-26-43-central-atividades-operacional',assetRevision:'app-beta-0-26-43-central-atividades-operacional',cacheName:'nexlab-beta-0-26-43-central-atividades-operacional',generatedAt:'2026-07-29T21:55:00Z'});
...
self.addEventListener('push',(event)=>{
  ...
  event.waitUntil(self.registration.showNotification(String(payload.title||'NEXLAB').slice(0,120),{
    ...
    icon:'./icons/nexlab-192.png?v=brand-r43',
    badge:'./icons/nexlab-192.png?v=brand-r43',
