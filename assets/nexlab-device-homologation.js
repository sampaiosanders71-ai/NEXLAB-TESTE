(function(){
  'use strict';
  const BUILD=globalThis.__NEXLAB_BUILD_IDENTITY__||Object.freeze({version:'0.26.82',revision:'beta-0-26-82-configuracoes-carregamento-corrigido',homologationRevision:'beta-0-26-82-configuracoes-carregamento-corrigido'});
  const VERSION=BUILD.version;
  const BUILD_REVISION=BUILD.revision;
  const REVISION=BUILD.homologationRevision||'beta-0-26-82-configuracoes-carregamento-corrigido';
