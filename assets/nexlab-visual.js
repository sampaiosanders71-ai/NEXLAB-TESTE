(function(){
  ...
  const FEEDBACK_ASSIST_CONTEXT_KEY = 'nexlab:feedback-assist:context:v0.26.40';
  ...
  function ensureAccessibleFieldNamesBeta(){
    ...
    controls.forEach((control, index) => {
      ...
      control.dataset.nexlabAccessibleName = 'beta-0-26-40-accessible-name';
    });
  }
  ...
  /* Beta 0.26.40 — rótulos de versão, cronologia e metadados alinhados */
