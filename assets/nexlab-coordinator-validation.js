(function(){
  ...
  async function openValidation(options={}){
    const {body}=dialog('Validação dos coordenadores','Roteiro oficial de homologação da Beta 0.26.81. Cada item obrigatório precisa de aprovação registrada por Coordenador.');
