/* NEXLAB Beta 0.26.52 — ativo clássico protegido por compatibilidade. */
const __nexlabCompatibilityDetail=Object.freeze({group:"beta-0-26-11",sourceVersion:"0.26.11",targetVersion:"0.26.52",assetPath:"assets/nexlab-realtime-core-beta-0-26-11.js",mode:'lightweight-bridge',usedAt:new Date().toISOString()});
...
(function(){
  'use strict';
  const ID=globalThis.__NEXLAB_BUILD_IDENTITY__||Object.freeze({version:'0.26.11',release:'Beta',revision:'beta-0-26-11-device-homologation-server-evidence'});
