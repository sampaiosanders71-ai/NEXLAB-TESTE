(function(root){
  ...
  const REVISION='beta-0-26-77-telemetria-taxonomia-usabilidade-atividades';
  const RPC='nexlab_get_release_publish_gate_v02677';
  const ASSERT_RPC='nexlab_assert_release_publishable_v02677';
