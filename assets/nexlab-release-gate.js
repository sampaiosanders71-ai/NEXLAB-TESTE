(function(root){
  ...
  const REVISION='beta-0-26-73-gate-homologacao-fisica';
  const RPC='nexlab_get_release_publish_gate_v02673';
  const ASSERT_RPC='nexlab_assert_release_publishable_v02673';
