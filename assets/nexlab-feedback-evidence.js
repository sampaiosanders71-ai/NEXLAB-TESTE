(function(){
  ...
  const BUILD=globalThis.__NEXLAB_BUILD_IDENTITY__||Object.freeze({version:'0.26.64',revision:'beta-0-26-64-correcao-visual-permissoes-cache-css'});
  ...
  const DRAFT_KEY='nexlab:feedback-draft:v0.26.64';
