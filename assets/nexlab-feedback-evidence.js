(function(){
  ...
  const BUILD=globalThis.__NEXLAB_BUILD_IDENTITY__||Object.freeze({version:'0.26.39',revision:'beta-0-26-39-version-labels-chronology-rpc-governance'});
  ...
  const DRAFT_KEY='nexlab:feedback-draft:v0.26.39';
