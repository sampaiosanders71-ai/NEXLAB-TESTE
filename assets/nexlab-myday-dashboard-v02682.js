...
.nxl-clean-primary svg,.nxl-clean-outline svg{width:17px!important;height:17px!important}
...
.nxl-clean-tabs{margin-bottom:0}.nxl-clean-tabs-wrap{padding:3px;border-radius:13px}.nxl-clean-tab{min-width:116px;padding:8px 17px;font-size:10.5px;border-radius:9px}
...
.nxl-clean-primary{min-height:44px;padding:0 14px;font-size:10px;border-radius:10px;gap:9px}
