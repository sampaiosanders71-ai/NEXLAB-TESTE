(function(){
  'use strict';
  const BUILD_IDENTITY=window.__NEXLAB_BUILD_IDENTITY__||Object.freeze({version:'0.26.49',release:'Beta',revision:'beta-0-26-49-convite-link-compartilhavel',assetRevision:'app-beta-0-26-49-convite-link-compartilhavel',cacheName:'nexlab-beta-0-26-49-convite-link-compartilhavel'});
  ...
  const HOMOLOGATION_REVISION=BUILD_IDENTITY.homologationRevision||'beta-0-26-49-convite-link-compartilhavel';
