(function(){
  'use strict';
  const BUILD_IDENTITY=window.__NEXLAB_BUILD_IDENTITY__||Object.freeze({version:'0.26.82',release:'Beta',revision:'beta-0-26-82-dashboard-finalizado',assetRevision:'app-beta-0-26-82-dashboard-finalizado',cacheName:'nexlab-beta-0-26-82-dashboard-finalizado'});
  ...
  const HOMOLOGATION_REVISION=BUILD_IDENTITY.homologationRevision||'beta-0-26-82-dashboard-finalizado';
