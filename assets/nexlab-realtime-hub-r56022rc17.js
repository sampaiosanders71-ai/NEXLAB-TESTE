...
const __nexlabCompatibilityDetail=Object.freeze({group:"legacy-26-31-22",sourceVersion:"26.31.22",targetVersion:"0.26.39",assetPath:"assets/nexlab-realtime-hub-r56022rc17.js",mode:'lightweight-bridge',usedAt:new Date().toISOString()});
...
(function(){
  'use strict';
  const ID=globalThis.__NEXLAB_BUILD_IDENTITY__||Object.freeze({version:'26.31.22',revision:'rc17-performance-hardening-r56022'});
