(function(root){
  ...
  const identity=Object.freeze({
    version:'0.26.48',
    displayVersion:'NEXLAB Beta 0.26.48',
    release:'Beta',
    channel:'beta',
    revision:'beta-0-26-48-dashboard-equipes-compacto',
    homologationRevision:'beta-0-26-48-dashboard-equipes-compacto',
    assetRevision:'app-beta-0-26-48-dashboard-equipes-compacto',
    cacheName:'nexlab-beta-0-26-48-dashboard-equipes-compacto',
