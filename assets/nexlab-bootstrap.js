(function(){
  ...
  const BUILD_IDENTITY = window.__NEXLAB_BUILD_IDENTITY__ || Object.freeze({version:'0.26.82',release:'Beta',revision:'beta-0-26-82-configuracoes-rolagem-independente',assetRevision:'app-beta-0-26-82-configuracoes-rolagem-independente',cacheName:'nexlab-beta-0-26-82-configuracoes-rolagem-independente',generatedAt:'2026-09-03T02:12:00Z'});
...
(function(){
  ...
  const REVISION=BUILD.revision||'beta-0-26-82-configuracoes-rolagem-independente';
  ...
  ]).map(path=>'./'+String(path).replace(/^\.\//,'')+'?v='+(BUILD.assetRevision||'app-beta-0-26-82-configuracoes-rolagem-independente'));
