(function(){
  ...
  const BUILD_IDENTITY = window.__NEXLAB_BUILD_IDENTITY__ || Object.freeze({version:'0.26.82',release:'Beta',revision:'beta-0-26-82-marketing-sem-gap-direita',assetRevision:'app-beta-0-26-82-marketing-sem-gap-direita',cacheName:'nexlab-beta-0-26-82-marketing-sem-gap-direita',generatedAt:'2026-08-29T01:34:38Z'});
...
(function(){
  ...
  const REVISION=BUILD.revision||'beta-0-26-82-marketing-sem-gap-direita';
  ...
  ]).map(path=>'./'+String(path).replace(/^\.\//,'')+'?v='+(BUILD.assetRevision||'app-beta-0-26-82-marketing-sem-gap-direita'));
