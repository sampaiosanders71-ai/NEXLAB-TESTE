(function(){
  ...
  const BUILD_IDENTITY = window.__NEXLAB_BUILD_IDENTITY__ || Object.freeze({version:'0.26.82',release:'Beta',revision:'beta-0-26-82-agenda-mobile-corrigida',assetRevision:'app-beta-0-26-82-agenda-mobile-corrigida',cacheName:'nexlab-beta-0-26-82-agenda-mobile-corrigida',generatedAt:'2026-08-22T16:26:20Z'});
...
(function(){
  ...
  const REVISION=BUILD.revision||'beta-0-26-82-agenda-mobile-corrigida';
  ...
  ]).map(path=>'./'+String(path).replace(/^\.\//,'')+'?v='+(BUILD.assetRevision||'app-beta-0-26-82-agenda-mobile-corrigida'));
