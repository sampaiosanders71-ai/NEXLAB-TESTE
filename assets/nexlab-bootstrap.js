(function(){
  ...
  const BUILD_IDENTITY = window.__NEXLAB_BUILD_IDENTITY__ || Object.freeze({version:'0.26.82',release:'Beta',revision:'beta-0-26-82-tarefas-equipes-pendencias',assetRevision:'app-beta-0-26-82-tarefas-equipes-pendencias',cacheName:'nexlab-beta-0-26-82-tarefas-equipes-pendencias',generatedAt:'2026-08-22T19:17:27Z'});
...
(function(){
  ...
  const REVISION=BUILD.revision||'beta-0-26-82-tarefas-equipes-pendencias';
  ...
  ]).map(path=>'./'+String(path).replace(/^\.\//,'')+'?v='+(BUILD.assetRevision||'app-beta-0-26-82-tarefas-equipes-pendencias'));
