(function(){
  ...
  const BUILD_IDENTITY = window.__NEXLAB_BUILD_IDENTITY__ || Object.freeze({version:'0.26.82',release:'Beta',revision:'beta-0-26-82-marketing-referencia-agenda',assetRevision:'app-beta-0-26-82-marketing-referencia-agenda',cacheName:'nexlab-beta-0-26-82-marketing-referencia-agenda',generatedAt:'2026-08-29T01:34:38Z'});
...
(function(){
  ...
  const REVISION=BUILD.revision||'beta-0-26-82-marketing-referencia-agenda';
  ...
  ]).map(path=>'./'+String(path).replace(/^\.\//,'')+'?v='+(BUILD.assetRevision||'app-beta-0-26-82-marketing-referencia-agenda'));
