(function(){
  ...
  const BUILD_IDENTITY = window.__NEXLAB_BUILD_IDENTITY__ || Object.freeze({version:'0.26.82',release:'Beta',revision:'beta-0-26-82-notificacoes-runtime-corrigido',assetRevision:'app-beta-0-26-82-notificacoes-runtime-corrigido',cacheName:'nexlab-beta-0-26-82-notificacoes-runtime-corrigido',generatedAt:'2026-09-03T02:12:00Z'});
...
(function(){
  ...
  const REVISION=BUILD.revision||'beta-0-26-82-notificacoes-runtime-corrigido';
  ...
  ]).map(path=>'./'+String(path).replace(/^\.\//,'')+'?v='+(BUILD.assetRevision||'app-beta-0-26-82-notificacoes-runtime-corrigido'));
