(function(){
  ...
  const BUILD_IDENTITY = window.__NEXLAB_BUILD_IDENTITY__ || Object.freeze({version:'0.26.82',release:'Beta',revision:'beta-0-26-82-marketing-lista-removida',assetRevision:'app-beta-0-26-82-marketing-lista-removida',cacheName:'nexlab-beta-0-26-82-marketing-lista-removida',generatedAt:'2026-08-29T20:37:15Z'});
...
(function(){
  ...
  const REVISION=BUILD.revision||'beta-0-26-82-marketing-lista-removida';
  ...
  ]).map(path=>'./'+String(path).replace(/^\.\//,'')+'?v='+(BUILD.assetRevision||'app-beta-0-26-82-marketing-lista-removida'));
