(function(){
  ...
  const BUILD_IDENTITY = window.__NEXLAB_BUILD_IDENTITY__ || Object.freeze({version:'0.26.82',release:'Beta',revision:'beta-0-26-82-equipes-vinculos-integrados',assetRevision:'app-beta-0-26-82-equipes-vinculos-integrados',cacheName:'nexlab-beta-0-26-82-equipes-vinculos-integrados',generatedAt:'2026-08-30T21:45:00Z'});
...
(function(){
  ...
  const REVISION=BUILD.revision||'beta-0-26-82-equipes-vinculos-integrados';
  ...
  ]).map(path=>'./'+String(path).replace(/^\.\//,'')+'?v='+(BUILD.assetRevision||'app-beta-0-26-82-equipes-vinculos-integrados'));
