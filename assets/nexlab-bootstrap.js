(function(){
  ...
  const BUILD_IDENTITY = window.__NEXLAB_BUILD_IDENTITY__ || Object.freeze({version:'0.26.82',release:'Beta',revision:'beta-0-26-82-marketing-lista-integrada',assetRevision:'app-beta-0-26-82-marketing-lista-integrada',cacheName:'nexlab-beta-0-26-82-marketing-lista-integrada',generatedAt:'2026-08-29T21:34:21Z'});
...
(function(){
  ...
  const REVISION=BUILD.revision||'beta-0-26-82-marketing-lista-integrada';
  ...
  ]).map(path=>'./'+String(path).replace(/^\.\//,'')+'?v='+(BUILD.assetRevision||'app-beta-0-26-82-marketing-lista-integrada'));
