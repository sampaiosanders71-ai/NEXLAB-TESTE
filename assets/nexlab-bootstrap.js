(function(){
  ...
  const BUILD_IDENTITY = window.__NEXLAB_BUILD_IDENTITY__ || Object.freeze({version:'0.26.82',release:'Beta',revision:'beta-0-26-82-marketing-sem-lista',assetRevision:'app-beta-0-26-82-marketing-sem-lista',cacheName:'nexlab-beta-0-26-82-marketing-sem-lista',generatedAt:'2026-08-29T19:33:33Z'});
...
(function(){
  ...
  const REVISION=BUILD.revision||'beta-0-26-82-marketing-sem-lista';
  ...
  ]).map(path=>'./'+String(path).replace(/^\.\//,'')+'?v='+(BUILD.assetRevision||'app-beta-0-26-82-marketing-sem-lista'));
