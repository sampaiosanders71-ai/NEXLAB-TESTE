(function(){
  ...
  const BUILD_IDENTITY = window.__NEXLAB_BUILD_IDENTITY__ || Object.freeze({version:'0.26.82',release:'Beta',revision:'beta-0-26-82-agenda-integrada-completa',assetRevision:'app-beta-0-26-82-agenda-integrada-completa',cacheName:'nexlab-beta-0-26-82-agenda-integrada-completa',generatedAt:'2026-08-22T14:31:00Z'});
...
(function(){
  ...
  const REVISION=BUILD.revision||'beta-0-26-82-agenda-integrada-completa';
  ...
  ]).map(path=>'./'+String(path).replace(/^\.\//,'')+'?v='+(BUILD.assetRevision||'app-beta-0-26-82-agenda-integrada-completa'));
